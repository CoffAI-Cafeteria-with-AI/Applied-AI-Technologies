...
def visualize_boxes_and_labels_on_image_array(
    ...
    category_index,
  #------------------------------------------
  #Code inserted from us: additional parameters
    filepath, 
    filename,
    fileBasename,
  #------------------------------------------
  ...
  #----------------------------------------------------------------------------
  #Code inserted from us: give prices to the food
  prices = {"Getränk": 1.1, "Salat": 0.8, "Hauptspeise": 3.5, "Beilage": 1.2, "Vorspeise": 1.1, "Dessert": 0.7, }
  price = 0
  #---------------------------------------------------------------------------
  ...
  #----------------------------------------------------
  #open file and write filename inside
  os.chdir(filepath)
        ...
        if not skip_labels:
          if not agnostic_mode:
            if classes[i] in six.viewkeys(category_index):
              ...
              #-----------------------------------------------------------------------------
              #Write additions into file
              f.write("Dazu gekommen: " + class_name + " für: " + str(prices[class_name]) + " € \n")
  ...
  #-------------------------------------------------------------------
  #Write finale price to file
  f.write("Finaler Preis: "+ str(np.round(price,1)) + " €")
  f.close()
  #-------------------------------------------------------------------
